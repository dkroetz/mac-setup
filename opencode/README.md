...
- **plugins/futilify-gw/** — Futilify Gateway provider plugin
- **browserless-url-fix** — builds `BROWSERLESS_URL` from `BROWSERLESS_BASE_URL` + `BROWSERLESS_TOKEN` env vars (disabled in `opencode.json`)
